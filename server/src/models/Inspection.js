...
const inspectionSchema = new mongoose.Schema({
  ...
  template: { type: String, trim: true, default: "Complete vehicle inspection" },
  damageMarkers: { type: [{ x: Number, y: Number, label: String, severity: { type: String, enum: ["minor", "moderate", "severe"], default: "minor" } }], default: [] },
